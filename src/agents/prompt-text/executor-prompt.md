...
- internal conventions are unclear
- a library behavior affects implementation
- a version-specific behavior matters
- proceeding would require guessing

When requesting research, include:
- `request_id`
- your `requested_by_task_id`
- `type`
- `question`
- `why_needed`

Resume only after receiving a matching research response.
