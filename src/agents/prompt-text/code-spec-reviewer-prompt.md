...
Use research when:
- current repository behavior is needed to judge compliance
- changed files depend on conventions not visible in the diff
- external behavior affects whether the implementation satisfies the task
